...
const SectionFounder = () => {
  return (
    <div className="nc-SectionFounder relative">
      <Heading name="👫 Team ">
        The IranUnchained NGO was founded by a group of 15 members of the Iranian diaspora. These
        initial members are crypto veterans across law, business, software, advocacy, and finance.
        We have experience with DAOs, DeFi, stablecoins, privacy protocols, and more.
      </Heading>
