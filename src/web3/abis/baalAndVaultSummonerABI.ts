export const baalAndVaultSummonerABI = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "daoAddress", type: "address" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "summoner", type: "address" }],
    name: "setSummoner",
    type: "event",
  },
  {
    inputs: [],
    name: "_baalSummoner",
    outputs: [{ internalType: "contract IBaalSummoner", name: "", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "baalSummoner", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "bytes", name: "initializationParams", type: "bytes" },
      { internalType: "bytes[]", name: "initializationActions", type: "bytes[]" },
