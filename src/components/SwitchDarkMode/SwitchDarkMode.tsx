...
export interface ISwitchDarkModeProps {
  className?: string;
}

const SwitchDarkMode: React.FC<ISwitchDarkModeProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <span className="sr-only">Enable {isDarkMode ? "Light" : "Dark"} mode</span>
      {isDarkMode ? (
        <svg
          fill="none"
          height="24"
